...
export default function Slider({ movies }) {
  ...
  // this function uses slice method and takes two parameters, from and to. 
  // The subset includes movies starting from the from index up to (but not including) the to index.
