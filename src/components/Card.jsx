...
// (index, movieData, isLiked) change. This can help improve performance by avoiding unnecessary 
...
export default React.memo(function Card({ index, movieData, isLiked = false }) {
  ...
  // onMouseEnter detect when the mouse pointer enters a specific element
  return (
    <Container
